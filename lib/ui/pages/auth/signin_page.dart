...
import 'package:justcrew_flutter/ui/pages/auth/signup_page.dart';
...
class SignInPageState extends State<SignInPage> {
  ...
  Widget build(BuildContext context) {
    ...
    logger.d('SignInPageState user: ${fp.getUser()}');
    return Scaffold(
      key: _scaffoldKey,
  ...
  getRememberInfo() async {
    logger.d('getRememberInfo() doRemember: ${doRemember}');
  ...
  setRememberInfo() async {
    logger.d('setRememberInfo() doRemember: ${doRemember}');
